...
<head>
    ...
    <style>
        * {
        ...
        body {
            min-height: 100vh;
            background: radial-gradient(ellipse at 30% 20%, #0d1a2b, #060b12);
        ...
        .repo-card:hover {
            ...
            box-shadow: 0 12px 28px rgba(0, 10, 40, 0.4);
        }
        ...
        .repo-card .release-badge {
            position: absolute;
            top: 0.6rem;
            right: 0.6rem;
            background: rgba(70, 180, 100, 0.15);
            border: 1px solid rgba(70, 180, 100, 0.12);
            color: #7aff9e;
            font-size: 0.55rem;
        ...
        .btn-primary:hover {
            ...
            box-shadow: 0 0 25px rgba(60, 140, 255, 0.25);
        }
        ...
        (function() {
            ...
            function createCard(repo) {
                ...
                if (repo.language) {
                    ...
                    if (l.includes('javascript') || l.includes('js')) icon = 'fab fa-js';
                    else if (l.includes('typescript') || l.includes('ts')) icon = 'fab fa-js-square';
                    else if (l.includes('python')) icon = 'fab fa-python';
                    else if (l.includes('html')) icon = 'fab fa-html5';
                    else if (l.includes('css')) icon = 'fab fa-css3';
                    else if (l.includes('rust')) icon = 'fab fa-rust';
                    else if (l.includes('go')) icon = 'fab fa-golang';
                    else if (l.includes('java')) icon = 'fab fa-java';
                    else if (l.includes('php')) icon = 'fab fa-php';
                }

                card.innerHTML = `
                    <span class="repo-icon"><i class="${icon}"></i></span>
                    <h3>${esc(repo.name)}</h3>
                    ...
                    <div class="repo-stats">
                        ...
                        ${repo.language ? `<span><i class="fas fa-circle" style="color:#7aafff;font-size:0.4rem;"></i> ${esc(repo.language)}</span>` : ''}
                    </div>
                `;
                ...
                try {
                    ...
                    let html = `
                        ...
                        <div class="modal-stats">
                            ...
                            ${repo.language ? `<span class="modal-stat"><i class="fas fa-circle" style="color:#7aafff;"></i> ${esc(repo.language)}</span>` : ''}
            ...
            console.log('✅ RepowerStudio · финальная версия со слайдером');
        })();
    </script>
</body>
</html>
